...
def build_parser() -> argparse.ArgumentParser:
    ...
    request = sub.add_parser("translation-request", help="create a hash-bound zh-TW translation request")
    request.add_argument("--bundle-dir", type=Path, required=True)
    request.add_argument("--output", type=Path, required=True)

    apply_translation = sub.add_parser("apply-translation", help="apply a hash-bound zh-TW response")
    ...
    publish = sub.add_parser("publish", help="store a validated edition in sharded canonical storage")
    ...
    pages = sub.add_parser("build-pages", help="build the static multi-journal GitHub Pages portal")
